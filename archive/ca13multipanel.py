...
for tick in range(1000):
    ...
    eatC_njit(C1, ND1, size, a0, alpha1, gamma1, cAC, cCC)
    eatA_njit(C1, ND1, AC1, size, a0, alpha1, cAA, cAC)
    eatC_njit(C2, ND2, size, a0, alpha2, gamma1, cAC, cCC)
    eatA_njit(C2, ND2, AC2, size, a0, alpha2, cAA, cAC)
    eatC_njit(C3, ND3, size, a0, alpha3, gamma1, cAC, cCC)
    eatA_njit(C3, ND3, AC3, size, a0, alpha3, cAA, cAC)
    eatC_njit(C4, ND4, size, a0, alpha4, gamma1, cAC, cCC)
    eatA_njit(C4, ND4, AC4, size, a0, alpha4, cAA, cAC)
    eatC_njit(C5, ND5, size, a0, alpha1, gamma2_1, cAC, cCC)
    eatA_njit(C5, ND5, AC5, size, a0, alpha1, cAA, cAC)
    eatC_njit(C6, ND6, size, a0, alpha2, gamma2_2, cAC, cCC)
    eatA_njit(C6, ND6, AC6, size, a0, alpha2, cAA, cAC)
    eatC_njit(C7, ND7, size, a0, alpha3, gamma2_3, cAC, cCC)
    eatA_njit(C7, ND7, AC7, size, a0, alpha3, cAA, cAC)
    eatC_njit(C8, ND8, size, a0, alpha4, gamma2_4, cAC, cCC)
    ...
    if tick>0:
        ...
        COL_A = np.array([64, 35, 15], dtype='int')    # orange
        COL_C = np.array([250, 70, 0], dtype='int')    # magenta
